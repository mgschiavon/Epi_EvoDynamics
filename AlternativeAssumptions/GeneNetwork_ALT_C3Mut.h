...
//	EVOLUTIONARY MODEL USING "CUBE" MUTATION
//
...
class GeneNetwork
{
	...
	void mutateC3(long *seed, double M, parE PAR_E)
	{
		if(PAR_E.k)
		{
			k *= pow(M,(2*(double)ran1(seed))-1);
