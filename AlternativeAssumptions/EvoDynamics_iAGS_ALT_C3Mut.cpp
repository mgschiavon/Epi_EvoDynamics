...
// SIMULATIONS - ALTERNATIVE ASSUMPTIONS: "Cube" mutation
//
...
// defined in the GeneNetwork class (see GeneNetwork_ALT_C3Mut.h). The population 
// (N), environmental fluctuation frequency (nu), selection pressure (sT), 
// size mutation frequency (u), mutation step size (M), gene expression dynamics' 
...
// output file.
// NOTE: A variant from EvoDynamics_ALT_C3Mut.cpp that prints only AGS file and 
...
#include <time.h>
#include <cmath>
#include "GeneNetwork_ALT_C3Mut.h"
