...
//	EVOLUTIONARY MODEL USING MORAN MODEL
//
...
void selectionTournamentMM(GeneNetwork *myPop, int N, int t, double u, double M, long *seed, parE PAR_E)
{
	...
	j = int(N*(double)ran1(seed));
	// Substitute it by the selected cell:
	myPop[j] = myPop[maxT];
