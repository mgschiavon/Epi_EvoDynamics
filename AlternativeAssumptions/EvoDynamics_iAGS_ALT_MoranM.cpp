...
// genotype & subpopulations is printed in the AGS output file.
// NOTE: A variant from EvoDynamics_ALT_MoranM.cpp that prints only AGS file and 
//       the seed index needs to be specified as input by the user (from 0 to 9).
