...
// SIMULATIONS - ALTERNATIVE ASSUMPTIONS: "Homogeneous density" mutation
//
...
// NOTE: A variant from EvoDynamics_ALT_HDMut.cpp where the seed index needs 
...
#include <time.h>
#include <cmath>
#include "GeneNetwork_ALT_HDMut.h"
